...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        mapa = googleMap;
        PARQUECENTRAL = new LatLng(-1.0275420974378962, -79.46770917791586);
        CameraUpdate camUpd1 =
        CameraUpdateFactory
            .newLatLngZoom(PARQUECENTRAL,15);
    mapa.moveCamera(camUpd1);
    mapa.addMarker(new MarkerOptions().position(PARQUECENTRAL).title("PARQUE CENTRAL"));
    }
    ...
    private void setupLocationUpdates() {
        ...
        locationRequest.setInterval(1000); //Cada 5 seconds
